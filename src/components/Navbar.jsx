    ...
    <div className="sticky top-0 z-50 w-screen shadow-md bg-green-800">
      <div className="flex items-center justify-between max-w-[1240px] mx-auto px-4 py-3">
        ...
        <div className="hidden md:flex gap-6 text-white font-semibold">
          ...
          <Link to="/CarbonFootprint" className="hover:text-cyan-400">Carbon Footprints</Link>
          {user && <Link to="/UserDashBoard" className="hover:text-cyan-400">DashBoard</Link>}
...
//   return (
//     <div className="sticky top-0 z-50 w-full shadow-md bg-green-800">
//       <div className="flex items-center justify-between max-w-[1240px] mx-auto px-4 py-3">
...
//       {isModalOpen && (
//         <div className="fixed inset-0 bg-gray-700 bg-opacity-50 flex justify-center items-center z-40 mt-16"> {/* Adjusted the top margin */}
...
//                 Logout
//               </button>
//               <button className="bg-gray-300 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-400" onClick={toggleModal}>
//                 Close
//               </button>
//             </div>
//           </div>
...
//             <div className="flex items-center gap-4">
//             <span className="text-sm font-semibold">Welcome, {userName}</span>
//             <button className="bg-red-600 px-4 py-2 rounded-lg hover:bg-red-700" onClick={logout}>
//               Logout
//             </button>
//             </div>
//           ) : (
