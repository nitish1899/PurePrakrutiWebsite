    ...
    const fetchCarbonFootprintData = async () => {
      try {
        const [response1, response2, routeResponse] = await Promise.all([
          fetch(`http://localhost:5000/api/vehicle/carbonfootprint/dieselvehicles/${userId}`),
          fetch(`http://localhost:5000/api/vehicle/carbonfootprint/dieselvehicles1/${userId}`),
          fetch(`http://localhost:5000/api/vehicle/routewiseEmission/${userId}`)
        ]);

        if (!response1.ok) throw new Error("Failed to fetch dieselvehicles data");
        if (!response2.ok) throw new Error("Failed to fetch dieselvehicles1 data");
...
const downloadCSVReport = async () => {
  try {
    ...
    const response = await fetch(
      `http://localhost:5000/api/vehicle/carbonfootprintbyfueltype?fuelType=${selectedFuel}&${selectedDateRange}=true`
    );
            ...
            {["All", "Week", "Month", "Year"].map((filter) => (
              <button
                ...
                className={`px-4 py-2 rounded transition duration-200 ${
                  timeFilter === filter ? "bg-green-600 text-white" : "bg-gray-300"
                }`}
              >
                {filter}
              </button>
...
//   console.log("carbonFootprintData",dieselVehiclesData)
...
//         // Setting separate state variables
//         setDieselVehiclesData(data1?.carbonFootprintData || []);
//         setDieselVehiclesData1(data2?.carbonFootprintData || []);
//         setRouteWiseEmissionData(routeData?.routewiseEmissionData || []);
//       } catch (err) {
...
//     ...dieselVehiclesData.map(item => [item.date, parseFloat(item.carbonFootprint)]),
//   ];


//   const routeEmissionChartData = [
//     ['Route', 'Emission (kg CO2)'],
//     ...routeWiseEmissionData.map(route => [route.route, route.totalEmission]),
//   ];
...
//   const topEmittingVehicle = dieselVehiclesData.reduce((max, item) => 
//     parseFloat(item.carbonFootprint) > parseFloat(max.carbonFootprint) ? item : max
//   , dieselVehiclesData[0]);
...
//   return (
//   <div className='w-screen'>
//     <div className="bg-green-600 text-white p-16 text-center flex flex-wrap justify-between items-center w-full">
//       {/* Title */}
//       <motion.div
...
//         transition={{ duration: 0.8 }}
//       >
//         <div className="text-xl md:text-3xl font-bold">Carbon Emission Analysis</div>
//       </motion.div>

//       {/* Logo & Company Name */}
//       <motion.div
//         className="w-full md:w-auto flex justify-center md:justify-end items-center gap-4"
//         initial={{ opacity: 0, scale: 0.8 }}
//         whileInView={{ opacity: 1, scale: 1 }}
//         transition={{ duration: 0.8 }}
//       >
//         <div className="bg-green-500 p-3 md:p-4 rounded-full text-white font-bold flex items-center justify-center">
//           <span className="text-xl md:text-2xl">🚛</span>
//         </div>
//         <div>
//           <h3 className="text-lg md:text-xl font-semibold text-green-700">GreenLine Freight</h3>
//         </div>
//       </motion.div>
//     </div>
...
//         width="100%"
//         height="300px"
//         data={[["Date", "CO2"], ...dieselVehiclesData.map(item => [item.date, parseFloat(item.carbonFootprint)])]}
//       />
//     </div>
//   </div>
...
// >
//   <div className="bg-white p-4 rounded-lg shadow-md w-full">
//     <h2 className="text-lg font-bold mb-2 bg-green-600 text-center">Emission Over Time</h2>
//     <div className="w-full min-h-[300px]">
//       <Chart
//         chartType="ColumnChart"
//         width="100%"
...
//   <div className="bg-white p-4 rounded-lg shadow-md w-full">
//     <h2 className="text-lg font-bold mb-2 bg-green-600 text-center">Route-wise Emissions</h2>
//     <div className="w-full min-h-[300px]">
//       <Chart
//         chartType="PieChart"
//         width="100%"
//         height="300px"
//         data={[["Route", "Emission"], ...routeWiseEmissionData.map(route => [route.route, route.totalEmission])]}
//       />
//     </div>
//   </div>
// </motion.div>
...
//   return (
//   <div>
//       <div className="bg-green-600  text-white p-6 text-center flex justify-center  w-full">
//         <div className="text-3xl font-bold w-[20%]">Carbon Emission Analysis</div>
//         <div className="flex items-center justify-end w-[80%]">
//           <div className="bg-green-500 p-4 rounded-full text-white font-bold">
//             <span className="text-2xl">🚛</span>
//           </div>
//           <div className="ml-4">
//             <h3 className="text-xl font-semibold text-green-700">GreenLine Freight</h3>
...
//     <div className="bg-green-100 min-h-screen px-24 py-4">
...
//     {topEmittingVehicle && (
//       <>
//         <div className='font-bold'>{`GreenLine Freight: ${topEmittingVehicle.vehicleNumber}`}</div>
//         <h1>Top Emitting Vehicle</h1>
//       </>
//     )}
//   </div>
//   <div className="bg-green-800 p-4 rounded-full">
//     <div className='font-bold'>{`Total Vehicles: ${totalVehicles}`}</div>
//     <h1>Total Vehicles Registered</h1>
//   </div>
//   <div className="bg-green-800 p-4 rounded-full">
//     <div className='font-bold'>{`Total Emission: ${totalEmission.toFixed(2)} kg`}</div>
...
//           <h2 className="text-lg font-bold mb-2">Emission Over Time</h2>
//           <Chart chartType="ColumnChart" width="100%" height="300px" data={chartData} />
//         </div>
//         <div className="bg-white p-4 rounded-lg shadow-md">
//           <h2 className="text-lg font-bold mb-2">Route-wise Emissions</h2>
//           <Chart
//           chartType="PieChart"
//           width="100%"
//           height="300px"
//           data={routeEmissionChartData}
//         />
//         </div>
//       </div>

// {/* Fleet Emission Table */}
...
//           <th className="border p-2">Vehicle Number</th>
//           <th className="border p-2">Fuel Type</th>
//           <th className="border p-2">Carbon Emission (kg CO2)</th>
//           <th className="border p-2">Distance (km)</th>
//           <th className="border p-2">Last Updated</th>
//         </tr>
//       </thead>
